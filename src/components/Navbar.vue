  ...
  <div class="sticky top-0 z-50">
    ...
    <div class="navbar w-full drop-shadow-lg">
      <nav class="w-full flex justify-between">
        ...
        <!-- Men Category-->
        <div>
          <div @mouseenter="dropdownHandler(true)" class="flex"> 
            <button
              class="text-white text-2xl transition duration-150 ease-in hover:text-[#eeb711] justify-center"
            ...
            >
              <button
                ...
                :key="index"
                :id="index"
                @click="filterWithTypes(types, `men's clothing`)"
              >
                {{ types }}
              </button>
        ...
        <!-- Women Category-->
        <div>
          <div @mouseenter="dropdownHandler(false)" class="flex">
            <button
              class="text-white text-2xl transition duration-150 ease-in hover:text-[#eeb711] justify-center "
            ...
            >
              <div
                ...
                :id="index"
              >
                <button @click="filterWithTypes(types, `women's clothing`)">
                  {{ types }}
                </button>
              </div>
              <button @click="filterWithSex(`women's clothing`)">
                View All
              </button>
            </div>
          </div>
